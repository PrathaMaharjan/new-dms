...
export default function ExpensesPage() {
    ...
    // Fetch categories for the active outlet
    ...
    // Fetch expenses for the active outlet
    ...
    useEffect(() => {
        if (activeOutletId) {
            fetchCategories(activeOutletId);
            fetchExpenses(activeOutletId);
        }
    }, [activeOutletId, fetchCategories, fetchExpenses]);
    ...
    async function handleSaveExpense() {
        ...
        if (!activeOutletId) {
            setErrorMsg("Please select an outlet.");
            return;
        }
        ...
        try {
            ...
            await fetchExpenses(activeOutletId);
            resetForm();
            ...
            <div className="sticky top-0 z-20 w-full bg-white px-6 py-6 lg:px-10 border-b border-slate-900/5">
                <div className="flex flex-wrap items-center justify-between gap-3">
                    <div>
                        ...
                        <p className="mt-0.5 text-xs text-slate-500">Track and manage operational clinic expenses</p>
                    </div>
                    ...
                    {loading ? (
                        ...
                        <>
                                        ...
                                        {paginatedExpenses.length === 0 && (
                                            <tr>
                                                <td colSpan={6} className="px-6 py-16 text-center text-slate-500">
                                                    No expenses recorded for this outlet.
                                                </td>
                                            </tr>
                                        )}
                                    </tbody>
                            ...
                            <div className="block divide-y divide-slate-100 md:hidden">
                                ...
                                {paginatedExpenses.length === 0 && (
                                    <div className="px-4 py-12 text-center text-sm text-slate-400">No expenses recorded for this outlet.</div>
                                )}
                            </div>
