// src/app/api/doctors/me/status-chart/route.ts
import { getTodayStatusBreakdown } from "@/controller/doctor/doctorDashboard/homepage/controller";
...
export async function GET(request: NextRequest) {
  ...
  const result = await getTodayStatusBreakdown(locationId);
  if (!result.success) {
