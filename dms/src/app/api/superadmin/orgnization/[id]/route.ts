import { OrgErrorCode, updateOrganization } from "@/controller/superadmin/org/controller";
...
export async function PATCH(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  return NextResponse.json({ success: true, statusCode: 200, data: { organization: result.organization } });
}