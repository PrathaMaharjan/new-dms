...
export const PATIENT_ACCESS_TOKEN_MAX_AGE_SECONDS = 15;
...
export function signPatientAccessToken(payload: PatientAccessTokenPayload): string {
  return jwt.sign(payload, PATIENT_ACCESS_TOKEN_SECRET, { expiresIn: `${PATIENT_ACCESS_TOKEN_MAX_AGE_SECONDS}d` });
}
