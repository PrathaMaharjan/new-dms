...
export const createOrganizationWithOwnerSchema = z.object({
  ...
  firstOutletName: z.string().optional(),
  firstOutletAddress: z.string().optional(),
  firstOutletCity: z.string().optional(),
  firstOutletPhone: z.string().optional(),
  firstOutletEmail: z.string().email("Please enter a valid outlet email").optional().or(z.literal("")),
  firstOutletOpeningTime: z.string().optional(),
  firstOutletClosingTime: z.string().optional(),
